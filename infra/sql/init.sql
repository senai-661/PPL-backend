-- ============================================
-- DROP TABLES (caso queira resetar)
-- ============================================
...
CREATE TABLE corrida (
    ...
    status_corrida VARCHAR(20) NOT NULL 
        CHECK (status_corrida IN ('Em andamento', 'Finalizada', 'Cancelada'))
);
...
VALUES
('52998224725', 'Carlos', 'Silva', '1995-04-10', 'Rua A, 123 - Centro', 'carlos@email.com', '11999990001', '$2b$10$7a0XWnF1WmG0pYxJjXxJ9uG6v1JH7gHnL2gYw7mJ7Qp8VZbJm9mW2'),
('12345678909', 'Mariana', 'Souza', '1998-09-21', 'Av. Brasil, 456 - Zona Sul', 'mariana@email.com', '11999990002', '$2b$10$7a0XWnF1WmG0pYxJjXxJ9uG6v1JH7gHnL2gYw7mJ7Qp8VZbJm9mW2'),
('11144477735', 'João', 'Oliveira', '1992-12-05', 'Rua das Flores, 789 - Norte', 'joao@email.com', '11999990003', '$2b$10$7a0XWnF1WmG0pYxJjXxJ9uG6v1JH7gHnL2gYw7mJ7Qp8VZbJm9mW2');


INSERT INTO motorista
(cpf, cnh, nome_motorista, sobrenome_motorista, data_nascimento, celular, endereco, email, antecedentes_criminais, senha)
VALUES
('98765432100', '12345678901', 'Ricardo', 'Almeida', '1985-06-15', '11988880001', 'Rua B, 321 - Centro', 'ricardo@email.com', 'Nada consta', '$2b$10$7a0XWnF1WmG0pYxJjXxJ9uG6v1JH7gHnL2gYw7mJ7Qp8VZbJm9mW2'),
('74185296300', '23456789012', 'Fernanda', 'Costa', '1990-03-12', '11988880002', 'Av. Paulista, 1000', 'fernanda@email.com', 'Nada consta', '$2b$10$7a0XWnF1WmG0pYxJjXxJ9uG6v1JH7gHnL2gYw7mJ7Qp8VZbJm9mW2'),
('36925814706', '34567890123', 'Bruno', 'Lima', '1982-11-30', '11988880003', 'Rua C, 654 - Leste', 'bruno@email.com', 'Nada consta', '$2b$10$7a0XWnF1WmG0pYxJjXxJ9uG6v1JH7gHnL2gYw7mJ7Qp8VZbJm9mW2');
