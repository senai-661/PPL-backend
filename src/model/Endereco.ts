...
export class Endereco {
    ...
    public setRua(value: string) { this.rua = value; }

    public getNumero(): string { return this.numero; }
    public setNumero(value: string) { this.numero = value; }

    public getBairro(): string { return this.bairro; }
    public setBairro(value: string) { this.bairro = value; }

    public getCidade(): string { return this.cidade; }
    public setCidade(value: string) { this.cidade = value; }

    public getEstado(): string { return this.estado; }
    public setEstado(value: string) { this.estado = value; }

    public getCep(): string { return this.cep; }
    public setCep(value: string) { this.cep = value; }
    ...
    static async cadastro(endereco: Endereco): Promise<boolean> {
        try {
            ...
            const valores = [
                ...
                endereco.complemento, endereco.id_motorista, endereco.id_passageiro
            ];
