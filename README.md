...
[Sobre](#-sobre-o-projeto) • [Funcionalidades](#-funcionalidades) • [Normas e Legislação](#-normas-e-legislação) [Rotas da API](#-rotas-da-api) • [Como rodar](#-como-rodar) • [Variáveis de Ambiente](#-variáveis-de-ambiente) • [Contribuindo](#-contribuindo)
